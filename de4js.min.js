...
if(window.location.href.indexOf("bloggerbyte","encrypted-links")>-1){return true}else{setTimeout(function(){window.location.href='https://tools.bloggerbyte.net'},3000)}});
