...
How to use :
1. Cara ENKRIPSI = aesCrypto.encrypt(convertstr('LOCATE HERE TEXT YOU WANT TO ENSCRIPTION'),convertstr('root'));
2. Cara DEKRIPSI = aesCrypto.decrypt(convertstr('LOCATE HERE TEXT YOU WANT TO DECRIPSE'),convertstr('root'));
*/
